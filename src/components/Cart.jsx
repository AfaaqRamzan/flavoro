...
const Cart = () => {
  return (
    <>
      <div
        className={
          "fixed right-0 top-0 w-full lg:w-[20vw] h-full p-5 bg-white mb-3  transition-all duration-500 z-50"
        }
      >
      ...
      <FaShoppingCart
        className={
          "rounded-full bg-white shadow-md text-5xl p-3 fixed bottom-4 right-4"
        }
      />
    </>
  );
