  ...
  return (
    <div className="font-bold w-[250px] bg-white p-5 flex flex-col rounded-lg gap-2">
      ...
      <div className="text-sm flex justify-between">
        <h2>food name</h2>
        <span className="text-green-500 ">Rs.200</span>
      </div>
      <p className="text-sm font-normal">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto sint soluta ipsam debitis praesentium sunt, beatae et. Repudiandae, modi quae!</p>
